...
Фронтенд обращается к бекенду через API-Gateway, который предоставляет доступ ко всем сервисам бекенда. Бекенд разделен на сервисы по бизнес функциям, сервисы содержат микросервисы по определенным сущностям.
...
| - | - |
| Backend | Создание несколько инстансов сервисов и отслеживание их состояния через Kubernetes, автоматический перезапуск при сбоях, использование nginx для балансировки нагрузки и защиты от ddos-атак |
| Frontend | Создание несколько инстансов и отслеживание их состояния через Kubernetes, автоматический перезапуск при сбоях, использование nginx для балансировки нагрузки и защиты от ddos-атак |
...
| Nginx | VRRP (Virtual Router Redundancy Protocol) |
