...
| - | - | - | - |
| user | регистрация, обновление |  | 3 |
| chat | создание чата, обновление |  | 116 |
| chat_user | добавление участника в чат |  | 500 |
| chat_type | добавление нового типа чата | 0 | 0 |
| user_role | добавление новой роли | 0 | 0 |
| message | отправка сообщения, редактирование |  | 31,478 |
| message_payload | отправка сообщения с вложением |  | 18,926 |
| contact | создание контакта |  | 58 |
| file | отправка сообщения с файлом |  | 9,484 |
| photo | отправка сообщения с фото |  | 6,295 |
| file_type | добавление нового типа файла | 0 | 0 |

Таблица 16 - нагрузка на чтение

| Таблица | Операция | Запросов в месяц | QPS |
| - | - | - | - |
| user | аутентификация, просмотр профиля |  | 53,966 |
| chat | получение списка чатов |  | 55,803 |
| chat_user | получения списка участников чата |  | 103,417 |
| chat_type | получение информации о чате |  | 103,417 |
| user_role | получение информации о чате |  | 103,417 |
| message | просмотр сообщений |  | 135,353 |
| message_payload | просмотр сообщений |  | 56,907 |
| contact | просмотр списка контактов |  | 63,313 |
| file | просмотр сообщений |  | 29,816 |
| photo | просмотр сообщений |  | 27,091 |
| file_type | просмотр сообщений |  | 56,907 |
