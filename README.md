...
Основные сервера будут распологаться в Москве, Екатеринбурге и Новосибирске. Данные между ними будут синхронизироваться через асинхронную репликацию. Запросы, меняющие состояние, от пользователей с дата-центров в Ростове-на-Дону и Санкт-Петербурге будут отправлятся в Москву, как наиближайший.

Таблица 9 - Нагрузка на дата-центры от запросов, меняющие состояние
