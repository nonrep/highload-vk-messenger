...
VK не публиковало информацию о количестве отправляемых пользователями голосовых сообщений, поэтому было принято решение взять статистику мессенджера Whatsapp [^8]: 7 млрд голосовых в день при 100 млрд текстовых сообщений в день, т.е. 7% от общего числа сообщений. Тогда пользователь VK мессенджера в среднем отправляет 136 * 0.07 =  9.52 голосовых сообщений в день.
...
| чтение сообщений | 71.8 млн * 136 / (24 * 60 * 60) = 113,018  | 226,037 |
| чтение сообщений с фото | 71.8 млн * 136 * 0.2 / (24 * 60 * 60) = 22,603 | 45,207 |
| чтение сообщений с видео | 71.8 млн * 136 * 0.1 / (24 * 60 * 60) = 11,301  | 22,603 |
| чтение голосовых сообщений | 71.8 млн * 9.52 * 3.59 / (24 * 60 * 60) = 28,401  | 56,803 |
| чтение сообщений с файлами | 71.8 млн * 136 * 0.05 / (24 * 60 * 60) = 5,650 | 11,301 |
...
|  отправка сообщений с фото |  6,295 * (512 Б + 5 МБ) = 0.003  | 0.006 |
...
| чтение сообщений |  113,018 * 512 Б = 0.054 | 0.108 |
| чтение сообщений с фото | 22,603 * (512 Б + 5 МБ) = 882.94 | 1765.88 |
|чтение сообщений с видео  | 11,301 * (512 Б + 60 МБ) = 5,297.349  | 10,594.698 |
| чтение голосовых сообщений | 28,401 * 64 Кб * 20 = 34.669  | 69.338 |
| чтение сообщений с файлами | 5,650 * (512 Б + 5 МБ) = 218.55 | 437.1 |
|  Авторизация | 11,966 * 100 КБ = 9.129 | 18.259 |
...
| Тип данных | Объем, ПБ |
|------------|-----------|
| Данные пользователей | 8.28 ГБ * 81.96 млн =  |
